...
namespace TMPro.Examples
{
    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        private const string label01 = "The <#0050FF>clickCount is: </color>";
        private const string label02 = "The <color=#0050FF>clickCount is: </color>";

        //private const string label01 = "TextMesh <#0050FF>Pro!</color>  The clickCount is: {0}";
        //private const string label02 = "Text Mesh<color=#0050FF>        The clickCount is: </color>";
